# 🎯 TrackLife - Personal Tracking System
...
TrackLife is a **complete personal tracking system** with an integrated AI Brain architecture. Originally built as a habit tracker, it has evolved into a **comprehensive life management platform** with:
...
- Storage key: `tracklife_timer_state`
...
- Storage key: `tracklife_notification_settings`

### Environment Variables (Brain System)
```bash
# .env file
DATABASE_PATH=landscaping.db
...
| Landscaping module | `landscaping_new/README.md` |
